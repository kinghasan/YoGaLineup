...
namespace Aya.DebugTool
{
	...
	public class Debugger : MonoBehaviour
	{
		...
		public void FitScreen()
		{
			...
			{
				scaleWidth = curWidth / oriHeight;
				scaleHeight = curHeight / oriWidth;
			}
			else
			{
				scaleWidth = curWidth / oriWidth;
				scaleHeight = curHeight / oriHeight;
			}

			GUI.matrix = Matrix4x4.TRS(new Vector3(0, 0, 0), Quaternion.identity, new Vector3(scaleWidth, scaleHeight, 1));
		}
