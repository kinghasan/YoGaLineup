...
{
    public static class ChainStyleExtension
    {
        #region Do
        ...
        public static SwithCase<TCase, TOther> Switch<TCase, TOther>(this TCase @case, Action<TOther> action) where TCase : IEquatable<TCase>
        {
            var result = new SwithCase<TCase, TOther>(@case, action);
            return result;
        }

        public static SwithCase<TCase, TOther> Switch<TInput, TCase, TOther>(this TInput input, Func<TInput, TCase> selector, Action<TOther> action) where TCase : IEquatable<TCase>
        {
            var result = new SwithCase<TCase, TOther>(selector(input), action);
            return result;
        }
        ...
        public static SwithCase<TCase, TOther> Case<TCase, TOther>(this SwithCase<TCase, TOther> swithCase, TCase option, TOther other) where TCase : IEquatable<TCase>
        {
            var result = Case(swithCase, option, other, true);
            return result;
        }

        public static SwithCase<TCase, TOther> Case<TCase, TOther>(this SwithCase<TCase, TOther> swithCase, TCase option, TOther other, bool bBreak) where TCase : IEquatable<TCase>
        {
            var result = Case(swithCase, c => c.Equals(option), other, bBreak);
            return result;
        }

        public static SwithCase<TCase, TOther> Case<TCase, TOther>(this SwithCase<TCase, TOther> swithCase, Predicate<TCase> predicate, TOther other) where TCase : IEquatable<TCase>
        {
            var result = Case(swithCase, predicate, other, true);
            return result;
        }

        public static SwithCase<TCase, TOther> Case<TCase, TOther>(this SwithCase<TCase, TOther> swichCase, Predicate<TCase> predicate, TOther other, bool bBreak) where TCase : IEquatable<TCase>
        {
        ...
        public static SwithCase<TCase, TOther> Default<TCase, TOther>(this SwithCase<TCase, TOther> swithCase, TOther other)
        {
            swithCase?.Action(other);
            return swithCase;
        }
